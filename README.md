...
Выбрала счётчик BRANCH потому что на мой взгляд его использование охватывает все ветви условий и можно убедиться, что тестами покрыты все комбинации кода.
